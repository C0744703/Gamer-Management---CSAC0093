				      	...
				      	if(request.getParameter("search")!=null)
				      	{
				      		...
				      		if(selectOption.isEmpty()||searchName.isEmpty())
				      		{
				      			...
				      			%>
				      			   <div class="row">
				       <div class="col-md-10">
							      <table class="table col-md-10 color_white" style="background: white;">
									  <thead>
									    <tr>
							  ...
							  <td><%=resultSet.getString(14) %></td>
							   <td><a class="btn btn-primary" href="edit.jsp?id=<%=resultSet.getInt(1)%> ">Edit</a></td>
							   <td><a class="btn btn-primary" href="delete.jsp?id=<%=resultSet.getInt(1)%> ">Delete</a></td>
						...
						<table class="table col-md-10 color_white" style="background: white;">
						  ...
						  %>
						    <tr>
							  ...
							  <td><%=resultSet.getString(10) %></td>
							  <td><%=resultSet.getString(14) %></td>
							   <td><a class="btn btn-primary" href="edit.jsp?id=<%=resultSet.getInt(1)%> ">Edit</td>
							   <td><a class="btn btn-primary" href="delete.jsp?id=<%=resultSet.getInt(1)%> ">Delete</td>
