			 ...
			 <div id="mainPart">
              ...
              <div class="row"> 
              	<div class="col-md-8">
	           	...
	           	<div class="col-md-4"> 
	              <button class="btn btn-primary  " onclick="retriveId('Approve')"><i class="icon-white icon-plus"></i> Approve </button>
	              <button class="btn btn-secondary" onclick="retriveId('Decline')"><i class="icon-white icon-bullhorn"></i> Decline</button>
	            </div>  
              </div>
				        ...
				        <div class="form-group row">
						    ...
						    <div class="col-sm-2">
								 ...
								 <option>Technology</option>
								  <option>Real Time Stretegy</option>
						     ...
						     <button type="submit" class="btn btn-light" name="search">Search</button>
						      <button style="margin:0px 12px" type="submit" class="btn btn-light" name="Sort">Descending</button>
						  </div>
				      ...
				      <div class="row">
				       <div class="col-md-10">
								  ...
								  Statement statement_=connection.createStatement();
						    		...
						    		//
						    		String qry_="select * from user";// ORDER BY userName  DESC";// where userAccessTypeActive='Active' or userAccessTypeActive='Declined'";// and userAccessTypeActive='No'";
						    		
						    		
						    		
						    		ResultSet resultSet_=statement_.executeQuery(qry_);
						    		System.out.println(resultSet_.next());
								  ...
								  %>
								     ...
								     <tr>
									      ...
									      <th scope="row"><input type="checkbox" onclick="testData('<%=resultSet_.getInt(1) %>')" value="<%=resultSet_.getInt(1) %> " id="userId" /><%=resultSet_.getInt(1) %> </th>
									      <td><%=resultSet_.getString(3) %></td>
										  <td><%=resultSet_.getString(4) %></td>
										  <td><%=resultSet_.getString(11) %></td>
										  <td><%=resultSet_.getString(9) %></td>
										  <td><%=resultSet_.getString(10) %></td>
										  <td><%=resultSet_.getString(9) %></td>
										    <td><%=resultSet_.getString(12) %></td>
				      ...
				      <div class="row">
				       <div class="col-md-10">
								  ...
								  Statement statement2=connection.createStatement();
						    		//String qry="select * from user where userAccessType='Elevated' and userAccessTypeActive='No'";
						    		//
						    		String mqry="select * from user";// ORDER BY userName ASC";// where userAccessTypeActive='Active' or userAccessTypeActive='Declined'";// and userAccessTypeActive='No'";
						    		
						    		
						    		int i=0;
						    		ResultSet resultSet=statement2.executeQuery(mqry);
								  ...
								  %>
								     ...
								     <tr>
									      ...
									      <th scope="row"><input type="checkbox" onclick="testData('<%=resultSet.getInt(1) %>')" value="<%=resultSet.getInt(1) %> " id="userId" /><%=resultSet.getInt(1) %> </th>
									      <td><%=resultSet.getString(3) %></td>
										  <td><%=resultSet.getString(4) %></td>
										  <td><%=resultSet.getString(11) %></td>
										  <td><%=resultSet.getString(9) %></td>
				      ...
				      function testData(data)
				      {
				    	 ...
				    	 this.id=data;
				      		...
				      		function retriveId(res)
				      		{
				      			...
				      			$.ajax({
				      			  type: "post",
				      			  url: "updateRequest.jsp", //this is my servlet
				      			  data: {input : id,val:res},
